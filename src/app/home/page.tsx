      ...
      <div className="container mx-auto px-4 md:px-6 z-10">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12">
          ...
          >
            ...
            >
              I build immersive digital experiences that combine cutting-edge technology with thoughtful design. Specializing in web applications, games, and interactive media.
            </motion.p>
