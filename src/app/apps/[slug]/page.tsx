...
import VideoModal from "@/components/app_details/VideoPlayer"; // this is now self-contained
...
const page = async ({ params }: PageProps) => {
  ...
  const data = appdata.find((app) => app.id === slug);
  ...
  return (
    <div className="min-h-screen dark:bg-black text-white flex flex-col items-center px-6 md:px-12">
      <div className="relative w-full min-h-[550px] overflow-hidden">
        {/* <div className="absolut inset-0 bg-black/50 backdrop-blur-sm z-10"></div> */}
