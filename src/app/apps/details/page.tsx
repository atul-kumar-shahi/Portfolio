    ...
    <div className="min-h-screen dark:bg-black text-white flex flex-col items-center px-6 md:px-12">
      ...
      <div className="container mx-auto px-6 relative">
        <button
          ...
          className="absolute right-6 top-7 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white py-2 px-6 rounded-full font-medium flex items-center gap-2 transition-all shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40"
        >
        ...
        {isModalOpen && (
  <VideoModal
    videoUrl="https://res.cloudinary.com/dp2i02kmy/video/upload/v1745136185/1494295-hd_1920_1080_24fps_fbkpoj.mp4"
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            ...
            >
              <p className="mb-4">
                Our cutting-edge Flutter application is designed to
                revolutionize how users interact with [specific domain] by
                providing a seamless, intuitive interface combined with powerful
                features that solve real-world problems.
              </p>
              <p className="mb-4">
                Leveraging the latest Flutter capabilities, the app offers
                cross-platform compatibility with native-like performance on
                both iOS and Android devices. The UI is crafted with Material
                Design principles and custom animations to create a delightful
                user experience.
              </p>
              <p className="mb-4">
                Key features include real-time synchronization, offline
                functionality, push notifications, and integration with external
                services. The app architecture follows clean code principles
                with a robust state management system, ensuring scalability and
                maintainability.
              </p>
              <p className="mb-4">
                From initial concept to final deployment, this project showcases
                my expertise in Flutter development, problem-solving abilities,
                and commitment to creating high-quality mobile applications that
                users love.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
                ...
                <p className="text-gray-300">
                  Built with Flutter for seamless iOS and Android support
                </p>
              </div>
              ...
              <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
                ...
                <p className="text-gray-300">
                  Beautiful interfaces with smooth animations
                </p>
              </div>
