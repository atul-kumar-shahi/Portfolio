...
import chess from "../../../public/chess.json";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto mb-8">
              Explore my favorite anime, movies, books, chess games, and music
              all in one place.
            </p>
            <a
              href="#anime"
          ...
          <div className="lg:flex lg:items-center lg:justify-between">
            <div className="lg:w-1/2">
              ...
              <p className="text-gray-300 mb-6">
                I&apos;m an enthusiastic hobbyist who loves diving deep into
                anime storylines, enjoying thought-provoking movies&lsquo;
                reading the occasional book, challenging myself in chess
                matches&lsquo; and discovering new music across various genres.
              </p>
              <p className="text-gray-300 mb-6">
                This page showcases my personal collection and experiences with
                my favorite hobbies. Feel free to explore and perhaps find some
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="mt-8 md:mt-0 md:order-1">
              <p className="text-center text-base text-gray-400">
                &copy; {new Date().getFullYear()} My Hobby Page. All rights
                reserved.
              </p>
            </div>
          </div>
